...
import com.carsguide.drivermanager.ManageDriver;
...
public class Utility extends ManageDriver {
    ...
    public void iClickOnElement(WebElement element) {
        element.click();
    }
...
//*************************** Select Class Methods ***************************************//
    ...
    public void iSelectByValueFromDropDown(WebElement element, String value) {
...
//*************************** Action Methods ***************************************//
    ...
    public void iMouseHoverToElement(WebElement element) {
        Actions actions = new Actions(driver);
...
*/
    ...
    public WebElement waitForElementWithFluentWait(WebElement webElement, int time, int pollingTime) {
        Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
                .withTimeout(Duration.ofSeconds(time))
                .pollingEvery(Duration.ofSeconds(pollingTime))
                .ignoring(NoSuchElementException.class);
...
//***************************** Is Display Methods **********************************************//
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/carsguide/screenshots" + screenshotName + dateName + ".png";
